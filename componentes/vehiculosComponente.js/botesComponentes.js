...
export default class Botes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
  ...
  componentDidMount() {
    return fetch('https://gtavehicles.000webhostapp.com/api/api-botes.php')
  ...
  render() {
    ...
    if (this.state.isLoading) {
      return (
        <View>
           <CustomHeader titulo="Botes" navigation={this.props.navigation} />
