...
export default class Motocicletas extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
  ...
  componentDidMount() {
    return fetch('https://gtavehicles.000webhostapp.com/api/api-motocicletas.php')
  ...
  render() {
    ...
    if (this.state.isLoading) {
      return (
        <View>
           <CustomHeader titulo="Moticicletas" navigation={this.props.navigation} />
